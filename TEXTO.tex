...
\textls[5]{Finalmente reconheço-me a mim mesmo e reencontro o quarto. É uma sensação de
...
Mas não era só isso: os objetos se deixavam tomar por um verdadeiro frenesi de
...
\letra{A}{s} \textls[15]{palavras cotidianas não têm valor em determinadas profundezas da
...
Num diálogo interior que, creio, nunca terminava, eu desafiava às vezes os
...
organizada normalmente nos limites de minha vida de criança.}\looseness=-1
...
\letra{P}{erto} da nossa casa, havia uma loja de máquinas de costura aonde eu
...
\textls[5]{As paredes ainda mantinham a pintura de salão, com guirlandas
...
\textls[5]{Do outro lado da cortina, Eugen tocava violino. Mantinha as
...
Um dia, sucedeu algo perfeitamente insólito. No início, o acontecimento
...
\textls[-5]{Na primeira vez que aconteceu entre nós o que eu esperava havia
 ...
 assim como foi naquele então.}\looseness=-1


\section{ix} 

\letra{E}{ugen} \textls[5]{estava fora para resolver coisas na cidade. Ficamos ambos na
...
\textls[15]{A verdadeira espera começava depois que Eugen saía. Era uma espera mais
...
\textls[15]{Clara se sentava junto à vitrine e tricotava: todos os dias era assim
...
\textls[5]{Eu jurava e em seguida ia atrás dela. Iniciava-se na cabine uma verdadeira
...
{serrr} o \textit{rrremédio}!''.}\looseness=-1
...
\letra{Q}{uando} \textls[15]{conheci Clara, eu tinha, salvo engano, doze anos. Não importa o
...
\letra{V}{ejo-me} \textls[10]{muito pequeno, vestindo um camisão até os calcanhares,
...
\textls[20]{--- É para cá que trazemos as meninas que pegamos --- disse Walter.}\looseness=-1
...
\textls[15
]{O céu lá fora, visto pela abertura da adega, tornava-se cada vez mais branco e
...
\textls[20]{--- Olhe\ldots{} uma estátua voadora\ldots{} olhe rápido\ldots{} logo vai se
    desfazer\ldots{}}\looseness=-1
...
\letra{U}{ma} \textls[5]{lembrança estreitamente ligada à pena vem-me à mente: um
...
\textls[5]{Alguns anos mais tarde, encontrei num livro de anatomia a fotografia de um
...
\textls[5]{Definitivamente, não há nenhuma diferença bem estabelecida entre a nossa
...
À luz triste dos candeeiros a carbureto, sentia realmente viver minha própria
...
\letra{S}{empre} tive uma estranha atração por acessórios femininos e por
...
barracas se organizava, se completava e de repente se tornava definitivo.}\looseness=-1
...
me parecia, naquele momento, barulho puro.}\looseness=-1
...
límpido para onde conduziam-me as \textit{crises} de infância.}\looseness=-1
...
\textls[10]{Eu costumava visitar Ozy assim como os cachorros entram em quintais alheios
...
\textls[10]{Dessa maneira, éramos capazes de falar de tudo, misturando coisas verdadeiras
...
compacta e absolutamente inacessível à minha compreensão.}\looseness=-1
...
lugar e nas mesmas circunstâncias que eu.}\looseness=-1
...
como do fumo entorpecedor do haxixe\ldots{}}\looseness=-1
...
\textls[5]{Pegava as ginjas e o pão que meu avô me dava e subia para o telhado. Dividia
...
em exposição na frente de uma loja.}\looseness=-1
...
\textls[15]{--- Pronto --- respondeu o irmão do morto. --- Agora vamos vesti-lo\ldots{}}\looseness=-1
...
\textls[10]{--- Aha! Quer dizer que está pronto --- disse de novo o homenzinho, espumando
    ...
    que se enterra um morto? Nessa sujeira desgraçada?}\looseness=-1
...
\textls[5]{Dia terrivelmente longo; um dia inteiro é demais para um casamento. No fundo
...
\textls[-5]{Finalmente anoiteceu.~As poucas árvores do quintal entranharam-se
...
Ao tentar me levantar, minha mão entrou nas formas esculpidas da madeira da
...
olhos. Sentia a pele ferver, ardendo como uma chama.}\looseness=-1
...
\textls[15]{O orvalho congelado pululava no frio do inverno, nas formas torneadas da água
...
\letra{U}{m} \textls[15]{dia, passando em frente ao teatro de variedades da
...
\textls[10]{Muito tempo depois daquele acontecimento, quando relembrei esse detalhe, as
...
\textls[20]{Durante algumas horas permaneci sossegado, numa beatitude perfeita.}\looseness=-1
...
\textls[10]{Tinha quase certeza de que, dessa vez, me encontraria com alguém, fosse no
...
\textls[10]{Pus-me a acariciar extaticamente os braços da poltrona. Queria que o estado em
...
\textls[20]{Comecei a fazer essas visitas embaixo do palco regularmente, toda tarde.}\looseness=-1
...
\textls[15]{\letra{C}{erta} tarde, essas excursões diárias ao subsolo do teatro
 terminaram, da mesma estranha maneira como haviam começado.}\looseness=-1
...
silêncio em dois campos bem distintos.}\looseness=-1
...
ainda se desculpasse por não me poder oferecer nada.}\looseness=-1

--- Está vendo, estou com gelo em cima da barriga\ldots{} estou com
    calor\ldots{} estou com calor\ldots{} me sinto muito mal\ldots{}

\textls[20]{Fui embora entristecido, sem nunca mais voltar ao teatro de variedades.}\looseness=-1


\section{xxxvi} 

\textls[-5]{\letra{O}{}outono chegou com seu sol avermelhado e suas manhãs embaçadas. As
...
\textls[-5]{No meio do céu, as nuvens se agrupavam e depois se dissipavam, deixando entre
...
\textls[15]{\letra{N}{aquele} dia, meus passos levaram-me até a margem da cidade, no
 descampado onde se organizava a feira de animais.}\looseness=-1
...
\textls[10]{Sua umidade elástica e seu cheiro cru me acolhiam até suas profundezas, pois
...
\textls[10]{Comecei a correr pelas ruas na escuridão, saltando por sobre as poças e
...
face do crânio --- um rosto terrível e assustador.}\looseness=-1
...
\textls[15]{Comecei a nutrir um amor insaciável pela cabeça. Era a coisa mais preciosa e
...
\textls[10]{--- Sofreu a noite toda --- disse-me ele. --- Ontem eu perguntei
...
\textls[-5]{\letra{Q}{uando} vez ou outra ponho-me a pensar nessas coisas, tentando
...
o aspecto de uma banalidade exata.}\looseness=-1
