...
\letra{A}{o fitar} por muito tempo um ponto fixo na parede, às vezes acabo não
 ...
 identidade como \textls[15]{se tivesse me tornado, de repente, um estrangeiro perfeito.
...
\textls[15]{A sensação de distanciamento e de solidão nos momentos em que minha pessoa
...
\textls[10]{Por vezes reconheço o quarto assim como ele é, como se eu fechasse e abrisse
...
\textls[-10]{Finalmente reconheço-me a mim mesmo e reencontro o quarto. É uma sensação de
...
\textls[15]{Agora, trata-se de uma solidão mais pura e mais patética. A sensação de
...
\textls[15]{Já de longe e muito antes de chegar à margem do rio, o cheiro das cascas
...
\textls[15]{Eu, contudo, não sabia muito bem o que estava fazendo. Já ao longo do rio, na
...
\letra{A}{lém} desses dois lugares malditos, o resto da cidade se perdia numa
 massa de uniforme banalidade, com casas que podiam ser confundidas umas com
 as outras, com \textls[15]{árvores imóveis ao exaspero, com cachorros, terrenos baldios
  e muita poeira.}
...
\textls[15]{Como se houvessem sido subitamente desempacotados de papéis finos e
...
\textls[10]{O quarto conservava vagamente a lembrança da catástrofe, como o cheiro de
...
\letra{A}{s palavras} \textls[10]{cotidianas não têm valor em determinadas profundezas da
...
\textls[15]{Para existir, ela deverá incluir algo da estupefação que me abarca quando
...
\textls[15]{A inutilidade preenchera as reentrâncias do mundo como um líquido que havia se
...
\textls[15]{Por essa inutilidade que me rodeia e debaixo desse céu eternamente amaldiçoado
ainda hoje eu passeio.}

\section{vii} 

\letra{P}{or causa} \textls[10]{das minhas \textit{crises}, levaram-me para ser examinado
...
%\textls[-25]{
O quinino receitado reforçou também minha convicção de que o médico tinha um
...
merece, creio eu, ser contado à parte.
...
\textls[15]{A loja era um simples espaço particular, alugado pela primeira vez para fins
comerciais.}
...
\textls[15]{E acrescentou, com um tom de maior erudição: ``A vida, em geral, é puro
teatro''.}

\textls[-10]{Do outro lado da cortina, Eugen tocava violino. Mantinha as
...
\textls[15]{Foi Clara quem o interrompeu. Falou quase aos sussurros, sem erguer os olhos
do tricô:}

\textls[15]{--- Se você tivesse vindo hoje mais cedo, poderíamos ter feito, pois Eugen
...
\textls[20]{No mesmo instante pus-me ao lado de Clara, peguei na sua mão e a acariciei
...
\textls[10]{Ao dizer \textit{tranquilos}, meu peito preencheu-se de uma esperança
fervente. Beijei-lhe de novo a mão e a puxei com força da cadeira. Ela se
deixou levar de mau grado, arrastando os pés pelo assoalho.}
...
\textls[10]{A verdadeira espera começava depois que Eugen saía. Era uma espera mais
difícil e mais insuportável do que a que havia se desenrolado até então; o
silêncio da loja se transformava num bloco de gelo.}
...
\textls[10]{Sentava-me numa cadeirinha à sua frente e começava a falar-lhe, a pedir-lhe, a
...
conceder uma permissão completa.}
...
prestando atenção e que \textit{sabia}.}\looseness=-1

\section{x} 

\letra{M}{ais} ou menos por essa época eu fora examinado pelo médico que me
 prescrevera quinino. A confirmação de minha impressão de que havia nele um
 quê de rato \textls[15]{ocorreu na cabine e, como disse, de uma maneira completamente
...
\textls[-13]{No mesmo fim de tarde, ao tomar o quinino, minha suposição foi reforçada por
...
\section{xii} 
%\textls[-20]{
\letra{V}{ejo-me} muito pequeno, vestindo um camisão até os calcanhares,
...
\textls[10]{No ar, um odor pungente de legumes podres, algumas moscas grandes, violetas,
...
\textls[5]{No meu quarto, meu pai acabara de me dar umas palmas no traseiro despido. Não
...
\textls[-15]{Quando o conheci, ele estava à sombra de uma acácia, sentado num tronco de
...
Saíam faíscas do olhar de Walter. Fiquei com um pouco \mbox{de medo.}
...
\textls[10]{Os degraus estavam apodrecidos e cheios de grama, as paredes estavam
...
descido dez degraus. Ali paramos.}
...
\textls[10]{Virei a cabeça e, desesperado, olhei para a abertura da adega acima de nós,
...
\textls[10]{Walter apareceu de repente com uma tábua, sobre a qual nos sentamos. Ficamos
...
\textls[-15]{``É para cá que trazemos as meninas que pegamos'', disse Walter.}

\textls[10]{Compreendi vagamente sobre o que deveria se tratar. A adega adquiriu uma
...
\textls[15]{--- Com a pena? Que tipo de pena? O que vocês fazem com as meninas?}

Walter deu risada de novo.

--- Quantos anos você tem? Você não sabe o que os homens fazem com as
    mulheres? Você não tem uma pena? Olhe aqui \mbox{a minha.}
...
\textls[15]{``Ei, o que é que você tem?'', perguntou Walter. ``Deixe eu lhe dizer
...
\textls[10]{Walter continuava falando comigo. Ele estava porém tão longe de mim e tão
...
\textls[15]{Walter se levantou.}

\textls[15]{--- Está vendo, isso lhe fez bem\ldots{} É assim que os índios guerreiros
    acordam os feridos; no nosso bando, conhecemos todos as mágicas e curas
    indígenas.}

\textls[10]{Acordei zonzo e exausto. Walter fugiu correndo e desapareceu. Subi os degraus com cuidado.}

\textls[5]{Nos dias seguintes, procurei-o por toda a parte --- em vão. Só me restava
...
\textls[15]{--- Olhe\ldots{} uma estátua voadora\ldots{} olhe rápido\ldots{} logo vai se desfazer\ldots{}}

\textls[15]{Após olhar atentamente, franzindo as sobrancelhas, a menina confessou não
...
\textls[15]{--- Eu sei por que você me enganou\ldots{} disse ela\ldots{} sei muito bem o que você quer\ldots{}}
...
\letra{U}{ma lembrança} \textls[-10]{estreitamente ligada à pena vem-me à mente: um
...
\textls[15]{Por vezes, no intuito de bloquear a onda de coisas e de cores que me inundava o cérebro, eu imaginava a evolução de um só contorno, ou de um só objeto.}
...
\textls[15]{As sombras dos navios deslizando pelos mares, sombras instáveis e aquáticas
...
\textls[15]{E a sombra solitária, perdida em algum lugar do espaço, do nosso redondo
planeta\ldots{}}
...
\textls[-10]{Ó, sala de cinema \textsc{b}., longa e soturna como um submarino naufragado! As portas
...
\letra{N}{o verão}, \textls[-5]{eu entrava cedo na matinê e saía tarde, ao anoitecer. A
...
\textls[15]{Quem nunca foi tomado por esse sentimento está condenado a jamais sentir a
verdadeira amplitude do mundo.}

\section{xviii} 

\letra{A}{impressão} \textls[-10]{geral e basicamente espetacular se transformava em
...
\textls[5]{É claro que o artista que o concebeu inspirou-se das visões do \textit
...
\textls[10]{Permanece vivo dentro de mim um único e supremo desejo: assistir ao incêndio
...
\letra{A}{lém} do \textit{panopticum}, a quermesse do mês de agosto trazia-me
 ...
 uma sinfonia, desde o \textls[10]{prelúdio dos cosmoramas isolados, que chegavam bem
...
\textls[15]{Os cosmoramas que chegavam mais cedo compreendiam, em essência, a quermesse
...
\textls[15]{Seguiram-se alguns instantes de um silêncio atroz.}
...
\textls[15]{O senhor do banco da frente ficou aturdido e embaraçado; enrubesceu até às
 orelhas e, retornando ao seu lugar, murmurou bem alto entre os dentes:}

\textls[15]{--- Ah, claro, nem é de se admirar, com uma maquininha daquelas no pescoço!}

Imperturbável, o artista respondeu de cima do palco:

\textls[15]{``Pois não, é só tentar'', disposto talvez a realmente conceder o prêmio a
...
melancolia de vida petrificada. \textls[10]{Das barracas vinha um cheiro forte de comida,
...
\textls[15]{Uma vez, num desses escaparates, deparei-me com minha própria fotografia. Esse
...
\textls[5]{Toda a minha própria vida, a daquele que estava em carne e sangue do lado de
...
\textls[15]{Naquele segundo, tudo me parecia caótico, assim como eu tapava minhas orelhas
...
\textls[15]{A tela de trás representava um parque esplêndido, com terraços em estilo
italiano e colunas de mármore.}

\textls[15]{Nessa paisagem onírica, o pequeno cadáver de mãos cruzadas sobre o peito, com
...
\textls[15]{Naqueles momentos, o morto com certeza estava indizivelmente feliz e
sossegado, na intimidade de sua paz profunda, no silêncio infinito do parque
de plátanos.}

\textls[10]{Logo, entretanto, ele foi arrancado da solenidade em que jazia e posto numa
...
\textls[15]{A quermesse então se tornava, para mim, uma ilha deserta sob o bafejo de
...
\letra{O}{andar} \textls[-15]{de cima da casa dos Weber, aonde eu ia com frequência desde a
...
\textls[15]{No primeiro aposento, que dá para a rua, foi instalado o escritório. Era um
...
\textls[15]{Um dia entrei e Ozy me disse, num tom terrivelmente seco, sem erguer os olhos
do livro:}
...
\textls[15]{``Olhe que eu também me resfriei'', disse-lhe, embora estivéssemos no mês
...
\textls[10]{``Mas é claro'', acrescentei, ``pois de onde ele teria para gastar com
...
\letra{E}{le era} \textls[10]{um menino ruivo, de mãos grandes e cabelo desgrenhado,
...
de desempenhar o papel de pai; \textls[10]{o violento cansaço dos mendigos dormindo em
...
\textls[10]{Assim, o andar completava sua galeria de \textit{panopticum}, começando pelo
...
\letra{E}{u também} encontrava velharias e objetos cheios de melancolia num
 ...
 esverdeadas de sonho. \textls[10]{Num canto jazia um fonógrafo com o bocal virado para
...
\textls[5]{Esses quadros me intrigaram por muito tempo. O artista parecia-me muito
...
\textls[15]{Em todo o desenho não havia um único sinal de lápis ou pincel; tudo era uma
...
\textls[15]{Sendo as paredes da casa bastante espessas, as janelas eram profundas,
formando nichos onde se podia estar muito confortavelmente.}

\textls[15]{Instalava-me num deles como num quartinho de vidro e abria a janela que dava
para a rua.}
...
\textls[15]{Certa vez, enquanto meu pai me contava lembranças da infância, perguntei-lhe
...
\textls[15]{Surpreso, respondeu-me que, de fato, a cada noite, quando subia para se
...
\textls[10]{No mundo havia, portanto, para além de lugares malditos que secretavam
vertigens e desânimos, outros espaços mais benéficos, cujas paredes
destilavam imagens belas e prazerosas.}

\textls[15]{As paredes do nicho destilavam o sonho de um veículo que percorre o mundo e
...
\textls[15]{Para que nada me parecesse excepcional durante a estada lá em cima, cada vez eu me obrigava a executar algo preciso e banal: ler, comer ou dormir.}

\textls[15]{Pegava as ginjas e o pão que meu avô me dava e subia para o telhado. Dividia as ginjas em quatro pedaços e assim os comia, um a um, para que minha atividade \textit{normal} durasse o máximo possível. A cada ginja terminada, esforçava-me em arremessar o caroço lá embaixo na rua, num caldeirão enorme em exposição na frente de uma loja.}
...
\letra{O}{andar} de cima se decompôs pedaço por pedaço, objeto por
 ...
 úmido do quintal, que \textls[10]{escolhera como refúgio de sua velhice e que não queria
  mais abandonar a não ser para o caminho derradeiro.}

\textls[15]{Todo dia eu o visitava ali, às vésperas da morte, e assisti à oração dos
...
\textls[10]{Enquanto esfregava, lágrimas se misturavam aos seus dentes e --- como se meu
...
\textls[15]{O cadáver estava deitado de bruços na mesa.}
...
\textls[25]{``Pronto'', respondeu o irmão do morto. ``Agora vamos vesti-lo\ldots{}''}

\textls[15]{``\textit{Aha}! Quer dizer que está pronto'', disse de novo o homenzinho, espumando
    ironia. ``Você realmente acha que está pronto? Você acha que é assim
    que se enterra um morto? Nessa sujeira desgraçada?''}

\textls[10]{No meio do aposento, com um feixe de palha na mão, o pobre velho ficou
...
achava que merecia tal insulto.}
...
\textls[15]{O irmão do meu avô, após ser sacudido por um tremor violento, desabou em
prantos\ldots{}}
...
\textls[15]{Que outra coisa senão enterrar seus mortos podiam fazer as pessoas num dia
como esse?}
...
\letra{P}{oucos} dias após o enterro do meu avô, Paul Weber se casou. Paul estava meio cansado no casamento, porém mantivera o sorriso; um sorriso
triste e forçado, em que \textls[10]{se vislumbrava o início de um devotamento.}
...
\textls[15]{No fundo do salão escuro, a noiva aguardava sentada em sua poltrona sobre o
estrado. Véus brancos cobriam seu rosto e só depois de sair do baldaquim e os
erguer é que eu vi Edda pela primeira vez\ldots{}}

\textls[10]{As mesas dos convidados estendiam-se brancas pelo quintal numa só fileira; na
...
\textls[15]{Pouco a pouco, o salão foi tomado pela névoa e tudo o que eu via tornou-se
...
\letra{A}{o chegar} \textls[-7]{à praça, alguns homens descarregavam carne para as
...
\textls[5]{Os cavalos das carroças fitavam as pessoas com seus olhos eternamente
...
\letra{O}{andar} de cima da casa dos Weber iluminou-se tão logo chegou Edda
 trazendo sombras e frescor, assim como certas claridades em bosques espessos
 se desanuviam \textls[10]{com a luz verde filtrada pelas folhas.}
...
objetos contorcionados e artificiais que saíam das cristaleiras.}
...
\textls[15]{O andar de cima embebeu-se de um aroma inefável, que lhe modificou o conteúdo
como uma essência forte misturada a uma bebida alcoólica.}
...
\textls[15]{A perfeição do mundo estava prestes a transparecer de qualquer lugar, como um broto que ainda tem de transpor uma última casca para rebentar ao ar livre.}

\textls[15]{Nas manhãs de verão, na sacada do andar de cima, algo acontecia e todo o meu corpo debalde se esforçava em compreender o quê, exatamente.}

\textls[15]{Para me encontrar com Edda, eu me armava com todos os amargores, todas as
...
\textls[10]{Mantinha as pernas uma sobre a outra, o que era uma posição de descanso
 ...
 deixar entrever seus dentes de ouro.}

\textls[10]{Ele temia encostar no mais mínimo objeto e, ao passar pela cortina de
miçangas, voltava-se e unia devagar as duas metades atrás de si, para não
produzir nenhum tilintar.}

\textls[15]{No caso de Ozy, todas as deformidades se acutizaram e se curvaram numa posição
...
\textls[15]{No que diz respeito a mim, não sei muito bem o que é que havia comigo naqueles
dias.}

\textls[5]{Numa tarde, enfiado numa das poltronas, comecei a pressionar com força minha
...
\textls[15]{Enfiava a cabeça no \textit{plush} cada vez mais e, na medida em que a dor se
...
\textls[10]{``Mas o que é que há com ele?'', perguntou Edda.}
...
\textls[10]{Com os olhos bem abertos e o rosto sangrando, ao observar-me ao espelho, não
...
\textls[15]{Edda molhou um lenço no álcool e limpou meu rosto. Tanto ardia que fechei os
olhos. Sentia a pele ferver, ardendo como uma chama.}

\textls[10]{Imerso em tontura, desci a escada para que as ruas ávidas me recebessem de
...
\textls[15]{O parque extravasara como lava; as pedras ferviam; minhas mãos estavam pesadas
e vermelhas.}

\textls[15]{Naquela desolação mole e quente, eu passeava com a imagem de Edda por vezes
...
\textls[5]{Eu compunha os detalhes de cenas imaginárias com a mais detalhada exatidão.
...
\textls[15]{A casa tinha um jardinzinho na frente, fracamente iluminado por uma lâmpada
elétrica.}
...
\textls[10]{Quanto tempo permanecera assim? De repente ouvi vozes na casa e em seguida a
...
\textls[15]{Continuei imóvel, decidido a enfrentar experiências mais graves que um simples
...
\textls[15]{Todos os meus desesperos berravam de novo dolorosamente dentro de mim.}
...
\textls[10]{Ao meu redor produziam-se as coisas mais simples e elementares da vida. Um
...
\textls[10]{Assim, por vezes surgiam da matéria alguns eczemas sublimes com supurações
rendadas, pintadas ou esculpidas.}

O orvalho congelado pululava no frio do inverno, nas formas torneadas da água
 aflita, e no verão brotavam flores em milhares de explosões miúdas, com
 flamas petaladas vermelhas, \mbox{azuis, alaranjadas.}
...
\textls[15]{Em vão eu acompanhava seu trabalho vagaroso para surpreender o momento em que
o pedaço úmido e esfarrapado de madeira expiraria numa rosa petrificada.}

\textls[15]{Em vão eu mesmo tentava cometer o milagre, passo a passo. Numa das mãos
...
\textls[15]{Caminhava enlouquecido pelas coisas que via e das quais o destino não me
permitia escapar.}
...
\letra{U}{m dia}, \textls[10]{passando em frente ao teatro de variedades da
 cidade, tomei coragem e entrei. Era uma tarde calma e luminosa. Atravessei um pátio sujo, com muitas portas
fechadas --- no fundo encontrei uma delas aberta, dando acesso a uma escada.}
...
conhecido.\looseness=-1

\textls[5]{Muito tempo depois daquele acontecimento, quando relembrei esse detalhe, as
...
veio porque tinha de vir, porque não tinha escapatória\ldots{}''}
...
\textls[15]{No fundo, uma porta dava para o sótão, onde encontrei roupas penduradas num
...
\textls[15]{Num dos lados havia uma escada descendente, por onde cheguei até o palco do
teatro.}

\textls[10]{Vi-me portanto, de repente, no palco vazio, diante da sala deserta. Meus
...
\textls[15]{De repente, vislumbrei o alçapão do ponto. Inclinei-me e olhei lá dentro.}

\textls[15]{Num primeiro momento nada pude distinguir, mas, pouco a pouco, descobri um
...
\textls[5]{Nela afundei, exausto. Finalmente encontrava-me num lugar neutro, onde ninguém
...
\textls[15]{A escuridão ao meu redor dissipou-se um pouco; a luz do dia chegava suja e
...
\textls[15]{Em torno de mim jaziam poltronas tortas, vigas empoeiradas e objetos
abandonados: era justamente o lugar comum a todos os meus sonhos.}

\textls[15]{Durante algumas horas permaneci sossegado, numa beatitude perfeita.}

\textls[15]{Até que por fim deixei o esconderijo pelo mesmo caminho que percorrera ao
chegar. Curiosamente, nem mesmo dessa vez não encontrei ninguém.}

\textls[15]{O corredor parecia incendiado pelas chamas do sol que se punha. O ralo
...
\textls[15]{Tinha quase certeza de que, dessa vez, me encontraria com alguém, fosse no
...
baixo do palco, custe o que custasse.}

\textls[15]{Passei pela mesma porta do pátio e subi pela mesma escada. O corredor estava
deserto como antes e não havia ninguém no sótão, nem na sala lá embaixo.}

\textls[10]{Em poucos minutos eis que me encontrava de novo no meu lugar, na poltrona
...
\textls[15]{Pus-me a acariciar extaticamente os braços da poltrona. Queria que o estado em
...
\textls[15]{Ao sair do sótão ao entardecer, uma mulher no corredor pegava água da
torneira.}
...
\textls[15]{Detive-me no alto da escada, desejoso de travar uma conversa com ela. Havia,
...
\textls[15]{Enquanto falava, uma porta se entreabriu e apareceu outra mulher.}

Ambas se aconselharam aos sussurros.

\textls[15]{``Muito bem, vamos levá-lo então até a Elvira, ela não tem mesmo o que
    fazer'', disse uma delas.}

\textls[15]{Conduziram-me até um quartinho escuro e acanhado, que eu jamais percebera, ao
...
\textls[15]{Num canto, uma mulher doente jazia na cama, coberta até a boca, batendo os
...
\textls[15]{Retendo de tudo o que lhe dissera apenas a palavra \textit{concurso}, ela me
respondeu com uma voz débil:}

\textls[10]{--- \ldots{} Certo\ldots{} certo\ldots{} vou prestar-lhe o meu concurso\ldots
     {} quando recobrar a saúde\ldots{} agora eu não posso\ldots{}}

\textls[10]{Ela tinha entendido que eu precisava de auxílio financeiro. Desisti de dar
explicações e fiquei sem graça por alguns instantes, sem saber como preparar
minha partida.}

\textls[15]{Enquanto isso, ela começou a se lamentar com um tom bastante natural, como se
...
\textls[15]{Fui embora entristecido, sem nunca mais voltar ao teatro de variedades.}

\section{xxxvi} 

\letra{O}{outono}  \textls[-10]{chegou com seu sol avermelhado e suas manhãs embaçadas. As
...
\textls[15]{Como eu me sentiria bem naquele cenário barato e indiferente, que nada sabia de mim\ldots{}}
...
No parque, a chuva lavava as flores e as plantas murchas. O outono acendia
...
escuro e vermelho da terra. \textls[10]{Mais para lá jaziam batatas bondosas e brandas,
...
\textls[15]{Por vezes eu queria ser um cachorro para poder observar esse mundo molhado a
...
\textls[15]{Esse desejo, que há muito me habitava, revolveu-se frenético naquele dia de
outono no arrabalde\ldots{}}


\section{xxxvii} 

\letra{N}{aquele} \textls[15]{dia, meus passos levaram-me até a margem da cidade, no
 descampado onde se organizava a feira de animais.}

\textls[15]{Diante de mim, o arrabalde se estendia encharcado pela chuva como uma imensa
...
\textls[10]{De repente me inclinei e meti as mãos no esterco. Por que não? Por que não?
...
%\textls[-20]{
O que haviam feito as minhas mãos até agora? Onde haviam perdido seu tempo? Eu
...
\textls[15]{Ao fitar a espiga, o silêncio dava uma risada mansa dentro de mim, como se, do
...
\textls[15]{Finalmente, observando fixamente as vigas acima de mim, fechei os olhos
cansados e adormeci.}

\textls[15]{Um sono profundo logo se apoderou de mim até a medula dos ossos.}

\textls[5]{Sonhei que passeava pelas ruas de uma cidade cheia de poeira, muito ensolarada
...
\textls[15]{Em seguida, subiu de volta ao trem e, pelo vidro, observei como instalara o
...
\textls[5]{No lamentável estado de sujeira em que me encontrava, não era possível. Mas
...
\textls[15]{Uma escuridão completa envolvia o quintal. Sentei-me num degrau e comecei a
...
\letra{E}{ra uma} cabeça bonita, extraordinariamente bonita. Aproximadamente três vezes maior que uma cabeça humana, girando lentamente sobre um eixo de latão que a atravessava do pescoço até a moleira.
...
\textls[15]{Assim que a cabeça começou a se mover, rodando sobre o eixo, fui invadido por
...
\textls[15]{As lâminas eram tantas e tão apertadas umas às outras, que, ao observar a
...
\textls[15]{Quando o vento soprava pelas folhas, a face ondulava como as ondas de um
trigal.}

\textls[20]{Da mesma maneira, a cabeça tremulava às oscilações do pedestal.}

\section{xl} 

\letra{P}{ara} \textls[10]{confirmar que a face era feita de lamelas, bastava afundar só
...
\textls[15]{Uma vez, na infância, assisti à exumação e ao sepultamento de um cadáver.}

\textls[15]{Era o de uma menina que morrera jovem e fora enterrada com vestido de noiva.}

\textls[10]{O espartilho de seda se desfizera em faixas compridas e sujas e, em alguns
...
\textls[12]{Quando o caixão foi retirado da cova, alguém passou a mão pelo rosto da morta.
...
\textls[15]{Foi nesse ar que a cabeça apareceu pela primeira vez, tendo-se criado ao seu
redor um vazio como uma auréola que crescia sem parar.}

\textls[15]{Fiquei tão alegre e satisfeito com o seu surgimento, que tinha vontade de dar
...
\textls[15]{Contra a \textit{cabeça} lutava incessante, cada vez mais impotente, o
escorrer gorduroso do ar.}

\textls[15]{Por vezes, ao seu lado, aparecia o meu pai, vago e indistinto, como uma massa
...
\textls[15]{Em torno da cabeça desencadeou-se um movimento enervante, como um drapejar de
bandeira.}
...
\textls[20]{Assim se desencadeara o movimento da bandeira no quarto. Agora havia o risco
...
\textls[15]{Em meio aos lençóis quentes, migalhas escorregavam por baixo das coxas. O pé
...
\textls[15]{A cama, no canto, jazia mergulhada na escuridão. Como conseguira eu, durante a
febre naquele escuro, distinguir nas paredes cada grão de cal?}

\textls[15]{Comecei a me vestir lentamente; as roupas também estavam mais leves do que de
...
\textls[5]{Não podia haver lugar melhor nesse mundo para bater pratos tranquilamente,
...
\textls[15]{Aos poucos, porém, despercebidamente, os movimentos do palhaço começaram a
...
\textls[15]{Abandonei rapidamente a vitrine e me dirigi a um pequeno parque público no
centro da cidade.}
...
\textls[10]{Sentou-se de repente ao meu lado um garoto robusto, com as mangas da camisa
...
bolso da calça um livro que pôs-se a ler.}
...
\textls[15]{Dei uma tossida significativa e o interpelei: ``O que você está lendo?'',
...
\textls[15]{``E\ldots{} sua cabeça não dói enquanto lê?\ldots{}'', perguntei,
...
\textls[15]{Levantei-me. Por um instante, os joelhos se dobraram inseguros como se
quisessem comparar, numa única hesitação, toda a minha força e fraqueza. Com
passos largos, pus-me na direção da casa de Edda.}

\textls[15]{A porta pesada de madeira que dava para o terraço estava fechada. Sua
...
\textls[15]{No aposento, entretanto, não se produziu a mínima surpresa, tensão ou emoção.}
...
\textls[5]{O pêndulo batia entre nós um tique-taque enervante e sonoro. Curioso: o
...
\textls[5]{Edda aninhou-se na cama, estreitando os joelhos na direção do seu corpo e
...
\textls[-5]{Vi de repente numa prateleira um grande buquê de flores dentro de um vaso.
...
\textls[15]{Aproximei-me da cama e me apoiei na barra de madeira. Sobre as minhas mãos
irradiou-se uma espécie de certeza, como se nelas houvesse de repente
penetrado todo o núcleo do meu desassossego.}
...
\textls[15]{Comecei a mover os lábios involuntariamente e a engolir em seco.}

``Está com fome?'', perguntou Edda.

\textls[10]{--- Ah, não, não\ldots{} não estou com fome, só estava pensando numa
    coisa\ldots{} absurda\ldots{} totalmente absurda.}

\textls[15]{--- Por favor me conte. Desde que chegou, você não disse uma palavra, nem eu
    lhe perguntei nada\ldots{} agora eu estou esperando, veja lá.}

\textls[10]{``Olhe, Edda'', comecei a dizer, ``trata-se de algo que, no fundo, é muito
    simples\ldots{} demasiado simples até\ldots{} me perdoe por lhe dizer
    isso, mas eu\ldots{}''}

\textls[5]{Quis continuar dizendo ``eu sou uma árvore'', mas a frase agora não tinha mais
...
\textls[15]{Pela primeira vez, senti a mente apertada forte dentro do crânio. Terrível e
doloroso cativeiro\ldots{}}

\section{xlii} 

\letra{N}{aquele} outono, Edda adoeceu e morreu. Todos os dias anteriores,
 todos os meus passeios inúteis, todas as minhas fadigas e perguntas
 torturantes concentraram-se \textls[5]{na dor e na angústia de uma única semana, como
  em certos líquidos em que a mistura de variadas substâncias condensa, de
  repente, a violência de um poderoso veneno.}

\textls[5]{No andar de cima, o silêncio desceu uma oitava. Paul lograra encontrar, não
...
\textls[15]{Paul falava rápido porém com longas pausas, como se desse tempo, entre uma e
outra palavra, para que a dor aguda dentro de si fervilhasse e se
consumisse.}

\textls[15]{O escritório do térreo estava escuro como uma caverna; o velho Weber, com a
...
\textls[15]{Eu os acompanhava, conversando com Ozy. Faz tempo que não brincávamos do nosso
jogo imaginário, de maneira que agora seria uma ocasião maravilhosa.}

\textls[15]{Que bom seria falarmos da doença de Edda como se nada daquilo fosse verdade!}
...
\textls[15]{Tudo, porém, estava muito bem montado para desistirem no alto da escada\ldots
{}}

\textls[-5]{Enquanto o médico entrava no quarto de Edda, ficávamos no aposento
...
\textls[15]{Edda estava deitada na cama com lençóis brancos, a cabeça virada para a
...
\textls[10]{O escritório do velho Weber foi todo revolvido para abrir espaço ao caixão que
...
\textls[10]{Em torno de suas botas de borracha a lama subia lenta mas tenaz, certamente
...
\textls[10]{Algo se debatia dentro de mim, ao longe, como se quisesse provar a existência
...
\textls[5]{Esse foi o último e mais insignificante episódio anterior ao subsolo do
...
mais ininteligível e mesquinha que seja, \textls[5]{cada lembrança é, apesar de tudo,
...
\textls[5]{Quero acordar, mas o sono escorre pesado das minhas pálpebras e dos meus
...
\textls[5]{Por fim, meu último grito, o mais forte, me desperta. Vejo-me logo no meu
...
\textls[15]{Quem me despertará?}

\textls[15]{Sempre foi assim, sempre, sempre.}