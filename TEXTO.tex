...
\letra{A}{o} \textls[25]{fitar por muito tempo um ponto fixo na parede, às vezes acabo não
...
\textls[20]{A sensação de distanciamento e de solidão nos momentos em que minha pessoa
...
\textls[15]{Por vezes reconheço o quarto assim como ele é, como se eu fechasse e abrisse
...
\textls[10]{Atormentar-me em insegurança não tem então nenhum motivo; é um simples
...
\textls[20]{Agora, trata-se de uma solidão mais pura e mais patética. A sensação de
...
\textls[20]{Só nesse desaparecimento súbito de identidade é que reencontro minhas quedas
...
\textls[15]{Eu descia ao rio numa corrida insana, por cima do monte de cascas. O ar se
...
\textls[20]{Eu, contudo, não sabia muito bem o que estava fazendo. Já ao longo do rio, na
...
\textls[15]{No fundo da cavidade formara-se uma pequena gruta, uma caverna sombreada e
...
\letra{A}{lém} \textls[25]{desses dois lugares malditos, o resto da cidade se perdia numa
...
\textls[20]{Como se houvessem sido subitamente desempacotados de papéis finos e
...
\textls[15]{Dava-me por mim no quarto arquiconhecido, transpirado, exausto e preenchido
...
\textls[10]{Para existir, ela deverá incluir algo da estupefação que me abarca quando
...
\textls[20]{Como uma espécie de equidade, porém, entre mim e o mundo (uma equidade que me
 ...
 neste mundo, mesmo as sobrenaturais.}
...
\textls[20]{Havia nisso tudo uma espécie de melancolia de existir e uma espécie de tortura
organizada normalmente nos limites de minha vida de criança.}

\textls[20]{Com o tempo, as \textit{crises} desapareceram por si sós, não sem deixar em
mim, para sempre, sua forte lembrança.}

\textls[20]{Ao entrar na adolescência, não sofri mais \textit{crises}, mas aquele estado
...
\textls[20]{A inutilidade preenchera as reentrâncias do mundo como um líquido que havia se
...
\textls[20]{Por essa inutilidade que me rodeia e debaixo desse céu eternamente amaldiçoado
...
\textls[20]{A loja era um simples espaço particular, alugado pela primeira vez para fins
comerciais.}
...
\textls[15]{No fundo da loja, um biombo de tábuas dividia uma espécie de cabine do resto
...
\textls[20]{E acrescentou, com um tom de maior erudição: ``A vida, em geral, é puro
teatro''.}
...
\textls[20]{Eu ia lá com tanta frequência que, com o tempo, tornei-me uma espécie de
...
\textls[20]{Tratei de corrigir a fatalidade, estendendo bem os joelhos na direção da mesa.
...
\textls[10]{A cumplicidade do vício é mais profunda e mais direta do que qualquer tipo de
...
\textls[15]{Na primeira vez que aconteceu entre nós o que eu esperava havia
...
\textls[20]{Foi Clara quem o interrompeu. Falou quase aos sussurros, sem erguer os olhos
do tricô:}

\textls[20]{--- Se você tivesse vindo hoje mais cedo, poderíamos ter feito, pois Eugen
...
\textls[25]{No mesmo instante pus-me ao lado de Clara, peguei na sua mão e a acariciei
ardorosamente. Beijei-lhe a mão. Ela a arrancou de mim.}
...
\textls[20]{Eu jurava e em seguida ia atrás dela. Iniciava-se na cabine uma verdadeira
...
\letra{M}{ais} \textls[20]{ou menos por essa época eu fora examinado pelo médico que me
...
\textls[10]{Assustado, virei a cabeça e vislumbrei, em cima da arca, atrás da caixinha de
...
\textls[-20]{No mesmo fim de tarde, ao tomar o quinino, minha suposição foi reforçada por
...
\textls[15]{Alguns meses depois da consulta, o médico foi encontrado morto no sótão de sua
...
\textls[20]{Pois, para que o médico morresse de verdade, era absolutamente necessário que
...
\textls[10]{Porém, ao investigar com atenção minhas mais remotas recordações, sua \textit
...
\textls[10]{No meu quarto, meu pai acabara de me dar umas palmas no traseiro despido. Não
...
\textls[25]{Extática, milagrosa, a figura de Walter mantém até hoje o seu brilho
fascinante.}
...
\textls[5]{--- Quero --- respondi-lhe com uma voz que não era mais minha e com um apetite
...
\textls[15]{Virei a cabeça e, desesperado, olhei para a abertura da adega acima de nós,
...
\textls[20]{Walter apareceu de repente com uma tábua, sobre a qual nos sentamos. Ficamos
...
\textls[25]{--- É para cá que trazemos as meninas que pegamos --- disse Walter.}

\textls[20]{Compreendi vagamente sobre o que deveria se tratar. A adega adquiriu uma
...
\textls[25]{--- Com a pena? Que tipo de pena? O que vocês fazem com as meninas?}
...
\textls[15]{Walter continuava falando comigo. Ele estava porém tão longe de mim e tão
...
\textls[25]{Walter se levantou.}

\textls[20]{--- Está vendo, isso lhe fez bem\ldots{} É assim que os índios guerreiros
    acordam os feridos; no nosso bando, conhecemos todos as mágicas e curas
    indígenas.}

\textls[20]{Acordei zonzo e exausto. Walter fugiu correndo e desapareceu. Subi os degraus com cuidado.}
...
\textls[10]{De repente, numa lufada de vento, tive a impressão de que uma estátua branca de mármore se alçava no ar. Havia naquele momento uma certeza, incontrolável como toda certeza. O bloco de pedra branca se distanciava rapidamente para cima, subindo oblíquo como um balão que escapa da mão de uma criança. Em poucos instantes, a estátua se transformou numa simples mancha branca no céu, do tamanho do meu punho. Agora eu podia ver distintamente duas pessoas brancas, de mãos dadas, deslizando pelo céu como dois esquiadores.}
...
\textls[25]{--- Olhe\ldots{} uma estátua voadora\ldots{} olhe rápido\ldots{} logo vai se desfazer\ldots{}}
...
\textls[25]{--- Eu sei por que você me enganou\ldots{} disse ela\ldots{} sei muito bem o que você quer\ldots{}}

\textls[10]{Começou a se distanciar de mim, pulando numa só perna. Levantei-me e corri
...
\letra{U}{ma} \textls[-10]{lembrança estreitamente ligada à pena vem-me à mente: um
 ...
 muitos segredos, visto que não podia ser encontrado em lugar algum.}
...
\textls[10]{Muitos anos mais tarde, reencontrei o livro na estante de uma livraria. Não
...
\textls[10]{Para onde quer que eu direcionasse o pensamento, ele sempre esbarrava com
...
\textls[20]{Por vezes, no intuito de bloquear a onda de coisas e de cores que me inundava o cérebro, eu imaginava a evolução de um só contorno, ou de um só objeto.}
...
\textls[20]{As sombras dos navios deslizando pelos mares, sombras instáveis e aquáticas
...
\textls[20]{E a sombra solitária, perdida em algum lugar do espaço, do nosso redondo
planeta\ldots{}}

\textls[5]{Noutra ocasião pus-me a pensar nas cavernas e buracos, nos desfiladeiros das
...
\textls[15]{No contexto desse espetáculo geral, havia outros espetáculos assombrosos que
...
\textls[20]{Eu vivia os episódios do filme com uma intensidade extraordinária,
...
\textls[20]{É claro que o artista que o concebeu inspirou-se das visões do \textit
...
\textls[10]{O violeta dos mortos por asfixia ao lado do vermelho pornográfico das
...
\textls[20]{Tudo isso emigrou do \textit{panopticum} para a vida. No cosmorama da
...
\textls[15]{Permanece vivo dentro de mim um único e supremo desejo: assistir ao incêndio
...
\letra{A}{lém} \textls[15]{do \textit{panopticum}, a quermesse do mês de agosto trazia-me
...
\textls[20]{Os cosmoramas que chegavam mais cedo compreendiam, em essência, a quermesse
...
\textls[20]{Da multiplicidade dos sons cotidianos desprendia-se de repente um zumbido que
...
\textls[20]{Na escuridão da avenida se acendia, ao entardecer, um diadema de cintilações
...
\textls[20]{Poucos dias depois, a quermesse já estava instalada. O semicírculo das
barracas se organizava, se completava e de repente se tornava definitivo.}

\textls[10]{Zonas bem estabelecidas a dividiam em regiões de sombras e de luzes --- as
...
\textls[15]{A representação inteira se revestia de um aspecto de improvisação e
...
por cima de nós, parecia ainda mais imenso\ldots{}}
...
\textls[15]{O artista aproximou-se da ribalta:}

\textls[15]{--- Senhores --- disse ele com uma voz rouca ---, trata-se de expulsar pela
    garganta a fumaça de um cigarro. }

\textls[20]{Ele acendeu um cigarro e, ao retirar a mão da gola, onde a mantinha todo o
...
\textls[20]{O senhor do banco da frente ficou aturdido e embaraçado; enrubesceu até às
 orelhas e, retornando ao seu lugar, murmurou bem alto entre os dentes:} 

\textls[25]{--- Ah, claro, nem é de se admirar, com uma maquininha daquelas no pescoço!}

\textls[15]{Imperturbável, o artista respondeu de cima do palco:}

\textls[25]{--- Pois não, é só tentar --- disposto talvez a realmente conceder o prêmio a
...
\textls[10]{De dia, imediatamente após a hora do almoço, debaixo do calor ardente do sol,
...
\textls[20]{Uma vez, num desses escaparates, deparei-me com minha própria fotografia. Esse
...
\textls[15]{Toda a minha própria vida, a daquele que estava em carne e sangue do lado de
...
\textls[10]{Assim chegavam até mim, do exterior, diversas advertências para me mobilizar e
...
\textls[20]{Naquele segundo, tudo me parecia caótico, assim como eu tapava minhas orelhas
...
\textls[20]{As portas do cosmorama estavam escancaradas e, do lado de dentro, diante do
cenário que servia de fundo para as fotografias, jazia sobre duas cadeiras o
caixão destampado.}

\textls[20]{A tela de trás representava um parque esplêndido, com terraços em estilo
italiano e colunas de mármore.}

\textls[20]{Nessa paisagem onírica, o pequeno cadáver de mãos cruzadas sobre o peito, com
...
\textls[20]{Naqueles momentos, o morto com certeza estava indizivelmente feliz e
sossegado, na intimidade de sua paz profunda, no silêncio infinito do parque
de plátanos.}

\textls[15]{Logo, entretanto, ele foi arrancado da solenidade em que jazia e posto numa
...
\textls[25]{A quermesse então se tornava, para mim, uma ilha deserta sob o bafejo de
...
\textls[20]{No primeiro aposento, que dá para a rua, foi instalado o escritório. Era um
...
\textls[15]{Alguns deles, depois de tantos anos na parede, haviam se integrado por
...
\textls[10]{Outro reclame familiar era o de uma firma de transportes que --- com seu barco
...
\textls[15]{No segundo cômodo, Ozy lia romances populares, afundado numa poltrona de
...
\textls[20]{Um dia entrei e Ozy me disse, num tom terrivelmente seco, sem erguer os olhos
do livro:}

\textls[5]{--- A aminopirina que tomei ontem à noite para transpirar me provocou uma
...
\textls[10]{Ao ganhar de novo a rua, eu tinha a sensação de ter dormido profundamente. Mas
...
\textls[20]{Às vezes Ozy não estava a fim de conversa e me levava consigo para rebuscar o
...
\letra{E}{le} \textls[15]{era um menino ruivo, de mãos grandes e cabelo desgrenhado,
...
\textls[20]{Tudo era muito simples; só Paul estava fora disso tudo, numa densidade de vida
...
\textls[20]{No andar de cima da casa dos Weber, Paul era a figura de cera mais enigmática
...
\textls[20]{Assim, o andar completava sua galeria de \textit{panopticum}, começando pelo
...
\textls[20]{Esses quadros me intrigaram por muito tempo. O artista parecia-me muito
...
\textls[20]{Em todo o desenho não havia um único sinal de lápis ou pincel; tudo era uma
...
\textls[20]{Em torno de mim, as superfícies do mundo embeberam-se subitamente de brilhos
...
\letra{A}{quele} \textls[30]{andar ainda tinha outras curiosidades que só a ele
 pertenciam. Por exemplo, o panorama da rua visto das janelas da frente.}

\textls[30]{Sendo as paredes da casa bastante espessas, as janelas eram profundas,
formando nichos onde se podia estar muito confortavelmente.}

\textls[20]{Instalava-me num deles como num quartinho de vidro e abria a janela que dava
para a rua.}
...
\textls[20]{Certa vez, enquanto meu pai me contava lembranças da infância, perguntei-lhe
...
\textls[20]{Surpreso, respondeu-me que, de fato, a cada noite, quando subia para se
...
\textls[15]{No mundo havia, portanto, para além de lugares malditos que secretavam
vertigens e desânimos, outros espaços mais benéficos, cujas paredes
destilavam imagens belas e prazerosas.}

\textls[20]{As paredes do nicho destilavam o sonho de um veículo que percorre o mundo e
...
\textls[20]{Para que nada me parecesse excepcional durante a estada lá em cima, cada vez eu me obrigava a executar algo preciso e banal: ler, comer ou dormir.}

\textls[20]{Pegava as ginjas e o pão que meu avô me dava e subia para o telhado. Dividia as ginjas em quatro pedaços e assim os comia, um a um, para que minha atividade \textit{normal} durasse o máximo possível. A cada ginja terminada, esforçava-me em arremessar o caroço lá embaixo na rua, num caldeirão enorme em exposição na frente de uma loja.}
...
\letra{O}{} \textls[15]{andar de cima se decompôs pedaço por pedaço, objeto por
...
\textls[20]{Todo dia eu o visitava ali, às vésperas da morte, e assisti à oração dos
...
\textls[15]{Enquanto esfregava, lágrimas se misturavam aos seus dentes e --- como se meu
...
\textls[20]{O cadáver estava deitado de bruços na mesa.}

\textls[20]{--- Pronto? --- perguntou um dos funcionários, um homenzinho de cavanhaque
    ruivo que estalava nervosamente os dedos, cheio de malícia.}

\textls[20]{--- Pronto --- respondeu o irmão do morto. --- Agora vamos vesti-lo\ldots{}}

\textls[20]{--- \textit{Aha}! Quer dizer que está pronto --- disse de novo o homenzinho, espumando
...
\textls[20]{O irmão do meu avô, após ser sacudido por um tremor violento, desabou em
prantos\ldots{}}

\textls[15]{O sepultamento ocorreu num dia canicular de verão: nada mais triste e mais
...
\textls[20]{Que outra coisa senão enterrar seus mortos podiam fazer as pessoas num dia
como esse?}

\textls[10]{No bafo e no langor do ar, seus gestos pareciam ter centenas de anos, os
...
\letra{P}{oucos} \textls[20]{dias após o enterro do meu avô, Paul Weber se casou. Paul estava meio cansado no casamento, porém mantivera o sorriso; um sorriso
...
\textls[20]{Pouco a pouco, o salão foi tomado pela névoa e tudo o que eu via tornou-se
...
\textls[10]{As ruas da cidade haviam perdido todo sentido; o frio entrava por debaixo da
...
\letra{A}{o} \textls[15]{chegar à praça, alguns homens descarregavam carne para as
...
\textls[15]{Os cavalos das carroças fitavam as pessoas com seus olhos eternamente
...
\textls[20]{Tudo se tornara longínquo e desolador. Era de madrugada; as pessoas
...
\textls[20]{Pus-me a correr como um louco pelas ruas. O sol surgiu vermelho de novo na
...
\textls[20]{Passei pelos fundos da casa dos Weber; as venezianas pesadas do andar de cima
estavam cerradas; tudo era triste e deserto; o casamento se consumara.}

\section{xxx} 

\letra{O}{} \textls[20]{andar de cima da casa dos Weber iluminou-se tão logo chegou Edda
...
\textls[20]{A primeira coisa que Edda fez foi cobrir as janelas com cortinas e espalhar
pelo chão tapetes macios que abafaram todos os ecos desolados do andar de
cima.}

\textls[20]{Toda manhã eu ficava na sacada, inventariando aquela quantidade imensa de
objetos contorcionados e artificiais que saíam das cristaleiras.}%\looseness=-1

\textls[15]{Junto com Ozy, eu os limpava conscienciosamente, para em seguida atirá-los
numa caixa que ia para o lixo.}

\textls[20]{Edda entrava e saía da sacada, envergando um roupão azul e uns chinelos cujos
...
\textls[20]{O andar de cima embebeu-se de um aroma inefável, que lhe modificou o conteúdo
como uma essência forte misturada a uma bebida alcoólica.}\looseness=-1

\textls[10]{Assim, todos os acontecimentos na minha vida eram fadados a surgir de forma
...
\textls[20]{A perfeição do mundo estava prestes a transparecer de qualquer lugar, como um broto que ainda tem de transpor uma última casca para rebentar ao ar livre.}

\textls[20]{Nas manhãs de verão, na sacada do andar de cima, algo acontecia e todo o meu corpo debalde se esforçava em compreender o quê, exatamente.}

\textls[20]{Para me encontrar com Edda, eu me armava com todos os amargores, todas as
humilhações e todo o ridículo necessário a uma aventura.}
...
\textls[20]{No caso de Ozy, todas as deformidades se acutizaram e se curvaram numa posição
...
\textls[20]{Sozinho, Paul caminhava por cima dos tapetes, calmo e seguro de si. Exibia
...
\textls[20]{No que diz respeito a mim, não sei muito bem o que é que havia comigo naqueles
dias.}

\textls[15]{Numa tarde, enfiado numa das poltronas, comecei a pressionar com força minha
...
\textls[20]{Enfiava a cabeça no \textit{plush} cada vez mais e, na medida em que a dor se
tornava mais violenta, aumentava a tenacidade da paciência de suportá-la.}

\textls[20]{Talvez exista dentro de nós um outro tipo de fome e um outro tipo de sede que
...
\textls[10]{De repente, Edda estacou com um disco de gramofone na mão, observando-me
estupefata. Ao meu redor criou-se um silêncio que me incomodou
desmesuradamente.}

\textls[15]{--- Mas o que é que há com ele? --- perguntou Edda.}

\textls[20]{Vi meu reflexo no espelho. Era ridículo, perfeitamente ridículo: no rosto, uma
...
\textls[25]{Edda molhou um lenço no álcool e limpou meu rosto. Tanto ardia que fechei os
olhos. Sentia a pele ferver, ardendo como uma chama.}

\textls[20]{Imerso em tontura, desci a escada para que as ruas ávidas me recebessem de
...
\textls[20]{O parque extravasara como lava; as pedras ferviam; minhas mãos estavam pesadas
e vermelhas.}

\textls[20]{Naquela desolação mole e quente, eu passeava com a imagem de Edda por vezes
...
\textls[15]{Eu compunha os detalhes de cenas imaginárias com a mais detalhada exatidão.
...
\textls[20]{A casa tinha um jardinzinho na frente, fracamente iluminado por uma lâmpada
elétrica.}
...
\textls[20]{Quanto tempo permanecera assim? De repente ouvi vozes na casa e em seguida a
...
\textls[20]{Alguns minutos depois, a luz se acendeu novamente e depois apagou-se. Alguém
de dentro da casa a ligava e desligava para ver que efeito isso teria sobre
mim.}

\textls[20]{Continuei imóvel, decidido a enfrentar experiências mais graves que um simples
jogo de luz. Mantinha a mão sobre o peito e o joelho no chão.}

\textls[20]{A porta se abriu e alguém saiu no quintal, enquanto uma voz grossa de dentro
...
\textls[15]{Essa compreensão tão espontânea me desarmou. Levantei-me e sacudi a poeira das
...
\textls[25]{Todos os meus desesperos berravam de novo dolorosamente dentro de mim.}
...
\letra{E}{u} era um garoto alto, magro, pálido, com um pescoço fino saindo da
 ...
 das minhas botas, quando eu ia andar pelas ruas do centro.

\textls[20]{Ao meu redor produziam-se as coisas mais simples e elementares da vida. Um
...
\textls[20]{Numa rua suburbana, havia um ateliê de escultura popular, onde eu também
passava muito tempo parado.}

\textls[15]{No ateliê havia milhares de coisinhas brancas e lisas, em meio às aparas
onduladas que caíam da plaina e enchiam o espaço com sua espuma rígida,
cheirando a resina.}

\textls[20]{O pedaço de madeira debaixo da ferramenta tornava-se mais fino, mais pálido,
...
\textls[15]{Havia também peças de xadrez com perfume de verniz fresco e paredes
completamente cobertas por flores e anjos.}

\textls[15]{Assim, por vezes surgiam da matéria alguns eczemas sublimes com supurações
...
\textls[20]{Em vão eu acompanhava seu trabalho vagaroso para surpreender o momento em que
o pedaço úmido e esfarrapado de madeira expiraria numa rosa petrificada.}

\textls[20]{Em vão eu mesmo tentava cometer o milagre, passo a passo. Numa das mãos
...
\textls[20]{Talvez, no momento em que eu começava a desbastar a madeira, um sono profundo
me envolvesse, enquanto forças extraordinárias surgiam do ar como tentáculos
que a penetravam, produzindo o cataclisma.}

\textls[20]{Talvez, naqueles momentos, o mundo inteiro parasse e ninguém soubesse do tempo
...
\textls[20]{A diversidade dos objetos que eu segurava, um após o outro, me aturdia. Em vão
...
\textls[20]{Por toda a parte ela infestara o ar, irrompendo nele, preenchendo-o com os
abcessos enquistados das pedras, com os ocos feridos das árvores\ldots{}}

\textls[20]{Caminhava enlouquecido pelas coisas que via e das quais o destino não me
permitia escapar.}

\textls[20]{Acontecia-me por vezes, entretanto, encontrar um lugar isolado onde podia
...
\textls[20]{Certa vez, encontrei um desses refúgios no lugar mais estranho e imprevisível
da cidade.}

\textls[15]{Era realmente tão bizarro que nem eu teria imaginado pudesse constituir uma
toca tão admirável e solitária.}

\textls[20]{Acho que só aquela sede ardente de preencher o vazio dos dias, de qualquer
...
mesma: ``\textit{Aha}!\ldots{} você veio!\ldots{}'', confundindo-me decerto com um
conhecido.
...
em emboscadas muito bem armadas. ``\textit{Aha}, você veio, dizia a voz do destino,
...
\textls[20]{As portas dos aposentos estavam fechadas; não se ouvia o mínimo ruído em parte
...
\textls[20]{Num dos lados havia uma escada descendente, por onde cheguei até o palco do
teatro.}

\textls[15]{Vi-me portanto, de repente, no palco vazio, diante da sala deserta. Meus
...
\textls[20]{Quis abrir a boca, sentia que tinha de dizer alguma coisa em voz alta, mas o
silêncio me petrificara.}

\textls[20]{De repente, vislumbrei o alçapão do ponto. Inclinei-me e olhei lá dentro.}

\textls[20]{Num primeiro momento nada pude distinguir, mas, pouco a pouco, descobri um
...
\textls[15]{Por toda a parte, a poeira se depusera em grossas camadas. Num canto jaziam
...
\textls[15]{Nela afundei, exausto. Finalmente encontrava-me num lugar neutro, onde ninguém
...
\textls[20]{A escuridão ao meu redor dissipou-se um pouco; a luz do dia chegava suja e
...
\textls[5]{Quem poderia desconfiar do meu paradeiro? Tratava-se do lugar mais insólito na
cidade inteira, onde, ao dar-me conta de estar ali, eu me deixava invadir por
uma calma alegria.}

\textls[20]{Em torno de mim jaziam poltronas tortas, vigas empoeiradas e objetos
abandonados: era justamente o lugar comum a todos os meus sonhos. }

\textls[25]{Durante algumas horas permaneci sossegado, numa beatitude perfeita.}

\textls[20]{Até que por fim deixei o esconderijo pelo mesmo caminho que percorrera ao
chegar. Curiosamente, nem mesmo dessa vez não encontrei ninguém.}

\textls[20]{O corredor parecia incendiado pelas chamas do sol que se punha. O ralo
...
\textls[20]{Passei pela mesma porta do pátio e subi pela mesma escada. O corredor estava
deserto como antes e não havia ninguém no sótão, nem na sala lá embaixo.}

\textls[20]{Em poucos minutos eis que me encontrava de novo no meu lugar, na poltrona
...
\textls[15]{Dessa vez também fiquei durante muito tempo, tendo ido embora mais uma vez sem
encontrar ninguém\ldots{}}

\textls[25]{Comecei a fazer essas visitas embaixo do palco regularmente, toda tarde.}

\textls[10]{Como se já fosse algo perfeitamente normal, os corredores estavam sempre
...
\letra{C}{erta} \textls[20]{tarde, essas excursões diárias ao subsolo do teatro
 terminaram, da mesma estranha maneira como haviam começado.}

\textls[20]{Ao sair do sótão ao entardecer, uma mulher no corredor pegava água da
torneira.}
...
\textls[20]{Detive-me no alto da escada, desejoso de travar uma conversa com ela. Havia,
...
\textls[10]{Alguns dias antes, um estudante, decerto contando vantagem, me dissera que ele
...
\textls[20]{Ambas se aconselharam aos sussurros.}

\textls[20]{--- Muito bem, vamos levá-lo então até a Elvira, ela não tem mesmo o que
...
\textls[20]{Num canto, uma mulher doente jazia na cama, coberta até a boca, batendo os
dentes. As outras mulheres foram embora, deixando-me sozinho no meio do
aposento.}

\textls[10]{Aproximei-me da cama. A doente tirou uma das mãos de sob o cobertor e a
...
\textls[20]{Retendo de tudo o que lhe dissera apenas a palavra \textit{concurso}, ela me
respondeu com uma voz débil:}

\textls[20]{--- \ldots{} Certo\ldots{} certo\ldots{} vou prestar-lhe o meu concurso\ldots
     {} quando recobrar a saúde\ldots{} agora eu não posso\ldots{}}

\textls[20]{Ela tinha entendido que eu precisava de auxílio financeiro. Desisti de dar
...
\textls[15]{--- Está vendo, estou com gelo em cima da barriga\ldots{} estou com
    calor\ldots{} estou com calor\ldots{} me sinto muito mal\ldots{}}

\textls[25]{Fui embora entristecido, sem nunca mais voltar ao teatro de variedades.}
...
\textls[20]{Como eu me sentiria bem naquele cenário barato e indiferente, que nada sabia de mim\ldots{}}
...
\textls[20]{Por vezes eu queria ser um cachorro para poder observar esse mundo molhado a
...
\letra{N}{aquele} \textls[25]{dia, meus passos levaram-me até a margem da cidade, no
...
\textls[20]{Eu mesmo era uma criação especial do barro, um missionário por ele enviado a
...
ininteligíveis\ldots{}}

\textls[10]{Em derredor se estendia o arrabalde cheio de lama\ldots{} Essa era a minha
...
\textls[20]{Caminhava em todas as direções. Afundei os pés até o tornozelo. Uma chuva
mansa caía e, ao longe, o sol ia dormir atrás da cortina de nuvens
ensanguentadas e purulentas.}

\textls[20]{De repente me inclinei e meti as mãos no esterco. Por que não? Por que não?
...
\textls[-15]{Estava feliz em poder me debruçar sobre uma pesquisa tão apaixonante. Os
...
\textls[20]{Ao fitar a espiga, o silêncio dava uma risada mansa dentro de mim, como se, do
...
\textls[20]{Finalmente, observando fixamente as vigas acima de mim, fechei os olhos
cansados e adormeci.}

\textls[20]{Um sono profundo logo se apoderou de mim até a medula dos ossos.}
...
\textls[20]{De repente, desembarcou de um compartimento da primeira classe um senhor
gordo, bem vestido, com a insígnia de uma condecoração na lapela.}

\textls[20]{Usava monóculo e polainas brancas. A careca se escondia debaixo de alguns fios
...
\textls[20]{Em seguida, subiu de volta ao trem e, pelo vidro, observei como instalara o
...
\textls[20]{Um sobressalto horrível me despertou.}

\textls[10]{Agora chovia muito forte. As gotas golpeavam o chão bem ao meu lado e tive de me estreitar junto à parede. O céu se enegreceu e, ao longe, não se via mais a cidade.}
...
\textls[15]{Pensei em me abrigar dentro da choupana. Mas a porta estava trancada e, no
...
\textls[10]{No lamentável estado de sujeira em que me encontrava, não era possível. Mas
...
\textls[20]{Pus um deles na língua, que soltou na boca um gosto meio salgado e insípido.
...
\textls[20]{Uma escuridão completa envolvia o quintal. Sentei-me num degrau e comecei a
...
\textls[20]{O quintal se transformou numa espécie de salão em que eu me sentia leve, cada
...
\letra{E}{ra} \textls[20]{uma cabeça bonita, extraordinariamente bonita. Aproximadamente três vezes maior que uma cabeça humana, girando lentamente sobre um eixo de latão que a atravessava do pescoço até a moleira.} 
...
\textls[20]{Assim que a cabeça começou a se mover, rodando sobre o eixo, fui invadido por
...
\textls[20]{Por outro lado, a pele era fantástica: formada por finas lâminas de carne
delgada, uma junto à outra, como as lamelas cor de café do lado de baixo dos
cogumelos.}

\textls[20]{As lâminas eram tantas e tão apertadas umas às outras, que, ao observar a
...
\textls[10]{Às vezes, durante o verão, ao contemplar as castanheiras de longe, carregadas
...
\textls[20]{Quando o vento soprava pelas folhas, a face ondulava como as ondas de um
trigal.}
...
\letra{P}{ara} \textls[20]{confirmar que a face era feita de lamelas, bastava afundar só
 ...
 lugar sem deixar marcas.}

\textls[20]{Uma vez, na infância, assisti à exumação e ao sepultamento de um cadáver.}

\textls[20]{Era o de uma menina que morrera jovem e fora enterrada com vestido de noiva.}

\textls[20]{O espartilho de seda se desfizera em faixas compridas e sujas e, em alguns
...
\textls[-15]{Quando o caixão foi retirado da cova, alguém passou a mão pelo rosto da morta.
...
\textls[20]{Por que contra o ar? No quarto, o ar estava eternamente em movimento, viscoso,
...
\textls[20]{Fiquei tão alegre e satisfeito com o seu surgimento, que tinha vontade de dar
risada. Mas como eu poderia rir na cama, no escuro da noite?}
...
\textls[5]{Perguntei-me, com certo receio, se essa cabeça não viria a se converter no
...
\textls[10]{A cabeça era o meu refresco e a minha felicidade pessoal. Talvez, se
...
\textls[20]{Contra a \textit{cabeça} lutava incessante, cada vez mais impotente, o
escorrer gorduroso do ar.}

\textls[20]{Por vezes, ao seu lado, aparecia o meu pai, vago e indistinto, como uma massa
...
\textls[20]{Em torno da cabeça desencadeou-se um movimento enervante, como um drapejar de
bandeira.}
...
\textls[25]{Assim se desencadeara o movimento da bandeira no quarto. Agora havia o risco
de ele fazer um furo em tudo, de me devorar, talvez\ldots{}}

\textls[20]{Gritei desesperado, encharcado de suor.}

--- Quanto? --- perguntou uma voz na sombra.

\textls[15]{--- Trinta e nove --- respondeu o meu pai, indo embora e deixando-me à mercê
    das tormentas que aumentavam.}

\section{xli} 

\letra{D}{e} \textls[5]{manhã, a convalescença se anunciou como uma extrema fragilidade
...
\textls[20]{Em meio aos lençóis quentes, migalhas escorregavam por baixo das coxas. O pé
...
\textls[15]{Sentei-me numa cadeira, debaixo da janela do teto. Ao meu redor, a luz
expulsava a exatidão dos objetos como se os lavasse com força até despi-los
de seu brilho.}

\textls[20]{A cama, no canto, jazia mergulhada na escuridão. Como conseguira eu, durante a
febre naquele escuro, distinguir nas paredes cada grão de cal?}

\textls[20]{Comecei a me vestir lentamente; as roupas também estavam mais leves do que de
costume. Dependuravam-se do meu corpo como pedaços de mata-borrão, exalando o
cheiro de lixívia do ferro de passar.}

\textls[15]{Flutuando por águas cada vez mais raras, saí de casa. O sol me entonteceu de
...
\textls[20]{O longo corredor de casas balançava levemente ao vento. De longe vinha o
...
\textls[15]{Não podia haver lugar melhor nesse mundo para bater pratos tranquilamente,
envergando belas roupas coloridas.}

\textls[20]{Eis finalmente algo simples e límpido depois de tanta febre. Na vitrine, a luz
...
objetos puros, dispostos com esmero em cima de uma folha de papel azul. \textit{Tim}!
\textit{Tim}! \textit{Tim}! Que gostoso, que gostoso é estar na vitrine! \textit{Tim}! \textit{Tim}! \textit{Tim}!
Vermelho, verde, azul; bolas, livros e tintas. \textit{Tim}! \textit{Tim}! \textit{Tim}! Que belo dia de
outono!\ldots{}}

\textls[20]{Aos poucos, porém, despercebidamente, os movimentos do palhaço começaram a
diminuir. Primeiro, os pratos não encostavam mais um no outro, e depois, de
repente, o palhaço parou com os braços fixos no ar.}

\textls[20]{Dei-me conta, quase horripilado, de que o palhaço parara de se mexer. Algo
dentro de mim petrificou-se dolorosamente. Um instante de alegria e beleza
congelara no ar.}

\textls[20]{Abandonei rapidamente a vitrine e me dirigi a um pequeno parque público no
centro da cidade.}
...
\textls[20]{Dei uma tossida significativa e o interpelei: ``O que você está lendo?'',
...
\textls[20]{--- E\ldots{} sua cabeça não dói enquanto lê?\ldots{} --- perguntei,
    devolvendo-lhe o livro.}

\textls[20]{Ele parecia não compreender.}
...
\textls[15]{Para isso, deveria talvez, antes de tudo, tentar respirar mais fundo e mais
...
\textls[15]{A minha atual posição no jardim era a de quem está no topo da frágil pirâmide.
...
\textls[10]{Fui visitado pelo pensamento de que era assim que eu deveria ver Edda, calmo,
...
\textls[20]{Levantei-me. Por um instante, os joelhos se dobraram inseguros como se
...
\textls[20]{Pousei a mão na maçaneta e a apertei. ``Coragem'', disse para mim mesmo;
...
\textls[20]{Bati com violência à porta de Edda.}

\textls[20]{Alarmada, disse-me que entrasse.}

\textls[20]{Por que meus passos eram tão silenciosos?}

\textls[20]{``Passos silenciosos?'' Parecia-me, contudo, que a presença de alguém como eu,
ou melhor, de uma árvore, deveria ser pressentida de longe.}

\textls[20]{No aposento, entretanto, não se produziu a mínima surpresa, tensão ou emoção.}
...
\textls[20]{Edda convidou-me a sentar, de maneira que me instalei numa cadeira a grande
distância dela.}

\textls[20]{O pêndulo batia entre nós um tique-taque enervante e sonoro. Curioso: o
...
\textls[20]{--- Edda --- comecei a falar, interrompendo o silêncio ---, permita-me lhe
    dizer uma coisa muito simples\ldots{}}

\textls[20]{Edda não respondeu.}

\textls[20]{--- Edda, você sabe o que eu sou?}

\textls[20]{--- O quê?}

\textls[20]{--- Uma árvore, Edda, uma árvore\ldots{}}

Todo esse breve diálogo ocorreu, é claro, estritamente no meu interior;
nenhuma palavra foi realmente pronunciada.

\textls[10]{Edda aninhou-se na cama, estreitando os joelhos na direção do seu corpo e
...
\textls[20]{--- Que flores bonitas aquelas --- disse a Edda.}
