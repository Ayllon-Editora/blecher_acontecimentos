...
\textls[10]{Havia nisso tudo uma espécie de melancolia de existir e uma espécie de tortura
...
\textls[10]{Tratei de corrigir a fatalidade, estendendo bem os joelhos na direção da mesa.
...
\textls[10]{Após olhar atentamente, franzindo as sobrancelhas, a menina confessou não
...
\textls[10]{--- Eu sei por que você me enganou\ldots{} disse ela\ldots{} sei muito bem o que você quer\ldots{}}

\textls[5]{Começou a se distanciar de mim, pulando numa só perna. Levantei-me e corri
...
\textls[5]{Na escuridão da avenida se acendia, ao entardecer, um diadema de cintilações
...
\textls[10]{Uma vez, num desses escaparates, deparei-me com minha própria fotografia. Esse
...
\textls[10]{Pegava as ginjas e o pão que meu avô me dava e subia para o telhado. Dividia as ginjas em quatro pedaços e assim os comia, um a um, para que minha atividade \textit{normal} durasse o máximo possível. A cada ginja terminada, esforçava-me em arremessar o caroço lá embaixo na rua, num caldeirão enorme em exposição na frente de uma loja.}
...
\textls[10]{O irmão do meu avô, após ser sacudido por um tremor violento, desabou em
prantos\ldots{}}

\textls[10]{O sepultamento ocorreu num dia canicular de verão: nada mais triste e mais
...
\textls[10]{Tudo se tornara longínquo e desolador. Era de madrugada; as pessoas
...
\textls[10]{Edda entrava e saía da sacada, envergando um roupão azul e uns chinelos cujos
...
\textls[10]{Sozinho, Paul caminhava por cima dos tapetes, calmo e seguro de si. Exibia
...
\textls[5]{A porta se abriu e alguém saiu no quintal, enquanto uma voz grossa de dentro
...
\textls[5]{Ao meu redor produziam-se as coisas mais simples e elementares da vida. Um
...
\textls[10]{Numa rua suburbana, havia um ateliê de escultura popular, onde eu também
...
\textls[10]{O pedaço de madeira debaixo da ferramenta tornava-se mais fino, mais pálido,
...
\textls[10]{Talvez, naqueles momentos, o mundo inteiro parasse e ninguém soubesse do tempo
...
\textls[10]{Caminhava enlouquecido pelas coisas que via e das quais o destino não me
permitia escapar.}
...
\textls[10]{Era realmente tão bizarro que nem eu teria imaginado pudesse constituir uma
toca tão admirável e solitária.}

\textls[10]{Acho que só aquela sede ardente de preencher o vazio dos dias, de qualquer
...
\textls[10]{As portas dos aposentos estavam fechadas; não se ouvia o mínimo ruído em parte
...
\textls[5]{Por toda a parte, a poeira se depusera em grossas camadas. Num canto jaziam
...
\textls[10]{Passei pela mesma porta do pátio e subi pela mesma escada. O corredor estava
...
\textls[10]{Dessa vez também fiquei durante muito tempo, tendo ido embora mais uma vez sem
encontrar ninguém\ldots{}}

\textls[15]{Comecei a fazer essas visitas embaixo do palco regularmente, toda tarde.}

\textls[5]{Como se já fosse algo perfeitamente normal, os corredores estavam sempre
...
\textls[10]{--- Muito bem, vamos levá-lo então até a Elvira, ela não tem mesmo o que
    fazer --- disse uma delas.}

\textls[10]{Conduziram-me até um quartinho escuro e acanhado, que eu jamais percebera, ao
...
\textls[10]{Num canto, uma mulher doente jazia na cama, coberta até a boca, batendo os
...
\textls[10]{Esse desejo, que há muito me habitava, revolveu-se frenético naquele dia de
...
\textls[10]{Diante de mim, o arrabalde se estendia encharcado pela chuva como uma imensa
...
\textls[10]{Eu mesmo era uma criação especial do barro, um missionário por ele enviado a
...
\textls[-22]{Da mesma maneira, a cabeça tremulava às oscilações do pedestal.}\looseness=-1
...
\textls[10]{Em torno da cabeça desencadeou-se um movimento enervante, como um drapejar de
bandeira.}
...
\textls[10]{Em meio aos lençóis quentes, migalhas escorregavam por baixo das coxas. O pé
...
\textls[10]{Sentei-me numa cadeira, debaixo da janela do teto. Ao meu redor, a luz
...
\textls[10]{A minha atual posição no jardim era a de quem está no topo da frágil pirâmide.
...
\textls[5]{Fui visitado pelo pensamento de que era assim que eu deveria ver Edda, calmo,
...
\textls[5]{Pousei a mão na maçaneta e a apertei. ``Coragem'', disse para mim mesmo;
...
\textls[10]{No aposento, entretanto, não se produziu a mínima surpresa, tensão ou emoção.}
...
\textls[5]{Ergui-me e precipitei-me na direção da prateleira. Atirada sobre um monte de
...
\textls[10]{--- De jeito algum\ldots{} --- respondeu-me ela, pondo-se a rir. Agora sim é
...
\textls[10]{Paul falava rápido porém com longas pausas, como se desse tempo, entre uma e
outra palavra, para que a dor aguda dentro de si fervilhasse e se
consumisse.}

\textls[10]{O escritório do térreo estava escuro como uma caverna; o velho Weber, com a
...
\textls[10]{Que bom seria falarmos da doença de Edda como se nada daquilo fosse verdade!}
...
\textls[5]{Tudo, porém, estava muito bem montado para desistirem no alto da escada\ldots
{}}
...
\textls[10]{No dia do enterro, o barro foi mais agressivo e sujo do que nunca. Rajadas de
...
\textls[5]{O escritório do velho Weber foi todo revolvido para abrir espaço ao caixão que
...
\textls[10]{O assoalho de madeira ressurgiu, no escritório, por debaixo do linóleo que o
...
\textls[5]{Em torno de suas botas de borracha a lama subia lenta mas tenaz, certamente
...
\textls[5]{Aquilo que eu interpretava como dor dentro de mim não passava de um leve
...
\textls[10]{Ela engloba a melancolia de ser único e limitado, num mundo único e
mesquinhamente árido.}

\textls[10]{Por vezes, à noite, desperto de um pesadelo terrível; é o meu sonho mais
...
\textls[10]{O que eu vejo agora ao meu redor difere muito pouco do que eu estava vendo um
